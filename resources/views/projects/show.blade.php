            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/projects') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Program Id </th><td> {{ $project->program_id }} </td></tr><tr><th> Title </th><td> {{ $project->title }} </td></tr><tr><th> Start At </th><td> {{ $project->start_at }} </td></tr>
                                </tbody>
                            </table>
                        </div>
